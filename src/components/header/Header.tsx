...
export default function Header() {
  ...
  return (
    <>
      <header
        className={`${pathname === "/about" || pathname === "/contact" ? "bg-custom-light-blue md:bg-secondary" : "bg-secondary md:bg-custom-light-blue"} mx-4 mt-5 flex h-12 items-center justify-between rounded-md p-4 lg:mx-20 lg:h-24 lg:px-7`}
      >
